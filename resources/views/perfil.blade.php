        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="../../index2.html" class="navbar-brand"><b>uni</b>CAH</a>
                ...
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    ...
                    <form class="navbar-form navbar-left" role="search">
                        <div class="form-group">
                            <input type="text" class="form-control" size="60" maxlength="50" id="formGroupExampleInput"
                                   placeholder="Buscar">
                        </div>
                    </form>
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="{{url('menu')}}">Inicio<span class="sr-only">(current)</span></a>
                        </li>
                        <li><a href="#">Link</a></li>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="box box-primary">
                                    <div class="box-body box-profile">
                                        ...
                                        <p class="text-muted text-center">{{\Illuminate\Support\Facades\Auth::user()->apellido}}</p>
